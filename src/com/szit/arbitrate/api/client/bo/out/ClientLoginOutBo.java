/**   
* @Title: ClientLoginOutBo.java
* @Package com.szit.cowell.api.client.bo.out
* @Description: TODO
* @author XUJC
* @date 2017年10月29日 上午8:43:16
* @version V1.0   
*/
...
/**
 * 
* @ClassName: ClientLoginOutBo
* @Description:登录成功后返回业务对象
* @author Administrator
* @date 2017年3月20日 下午2:46:33
* @UpdateUser:
* @UpdateDate:   
* @UpdateRemark:
