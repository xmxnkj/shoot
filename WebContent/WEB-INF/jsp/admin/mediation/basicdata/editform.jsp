		...
		<form id="editform" class="easyui-form" method="post">
			<table class="formtable">
				...
				<td class="tdHeader" style="width: 150px">参数类型<label class="required">*</label>:</td>
					<td class="tdContent">
					   <input id="dataType" data-fname="dataType" name="entity.dataType"/>
					 </td>
				</tr>
				...
				<!-- <input id="parentType" data-fname="parentType" name="entity.parentType" /> -->
			</table>
		</form>
	</div>
</div>
<script src="<s:property value="#attr.basePath" />adminresource/js/mediation/basicdata/editform.js?v=2017030703"></script>
</body>
</html>