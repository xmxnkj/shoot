...
<body>
	<script>
		...
		var saveUrl = "<s:url action="save" namespace="/sys/area" />";
		var serverValidateName = '<s:url action="validatename" namespace="/sys/area" />';
		
		var saveSucInfo = "地区保存成功！";
	...
	<div class="formdiv">
			<table class="formtable">
				<tr>
					<td class="tdHeader">地区名称<label class="required">*</label>：</td>
