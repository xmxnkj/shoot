...
<body>
	<script>
		var listjsonUrl = '<s:url action="listjson" namespace="/sys/area"/>';
		var editUrl = '<s:url action="edit" namespace="/sys/area" />';
		var deleteUrl = '<s:url action="delete" namespace="/sys/area" />';
	...
	<table id="tbl" data-options="fit:true">
		<thead>
			<tr>
				<th data-options="field:'name'">地区名称</th>
