...
<body>
	<script>
		...
		var saveUrl = "<s:url action="save" namespace="/sys/contentType" />";
		var serverValidateName = '<s:url action="validatename" namespace="/sys/contentType" />';
		
		var saveSucInfo = "内容类型保存成功！";
	...
	<div class="formdiv">
			<table class="formtable">
				<tr>
					<td class="tdHeader">内容类型名称<label class="required">*</label>：</td>
