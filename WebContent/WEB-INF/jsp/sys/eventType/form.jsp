...
<body>
	<script>
		...
		var saveUrl = "<s:url action="save" namespace="/sys/eventType" />";
		var serverValidateName = '<s:url action="validatename" namespace="/sys/eventType" />';
		
		var saveSucInfo = "事件类型保存成功！";
	...
	<div class="formdiv">
			<table class="formtable">
				<tr>
					<td class="tdHeader">事件类型名称<label class="required">*</label>：</td>
